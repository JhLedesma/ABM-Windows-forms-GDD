...
BEGIN
	...
	IF (EXISTS (SELECT FechaInicio FROM TRAEME_LA_COPA_MESSI.LogEstadia WHERE ReservaId = 10228) AND
	   (SELECT FechaFin FROM TRAEME_LA_COPA_MESSI.LogEstadia WHERE ReservaId = 10228) IS NULL)
