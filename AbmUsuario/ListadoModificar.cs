...
namespace FrbaHotel.AbmUsuario
{
    public partial class ListadoModificar : Form
    {
        ...
        {
            dataGridModificar.DataSource = Repositorios.Repo_usuario.getInstancia().getTablaUsuariosFiltradosConInactivosDelMismoHotel(filtroNombre.Text, filtroApellido.Text, filtroUsername.Text, numericUpDown1.Value);
        }
